...
Z_fix=0.5;   % select depth for plotting C(Z_fix,time)
dt= 1*86400;% timestep with in s
max_time= 50*86400; % maximum transport time s

R=0;        % Retardation coefficient [-] -> come from the footprint data base
dz=0.05; %grid  size m
lambda=0/(15*86400); % degradation time scale 1/s -> come from the footprint data base
%lambda=0.015/86400;
%lambda=0.;
