...
D=;    % dispersion coefficient m^2/s -> come from tracer experiments (method of moments)
v= ;    % average transport velocity m/s -> come from tracer experiments (method of moments)
