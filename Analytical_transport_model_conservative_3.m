...
D=7.6e-8;    % dispersion coefficient m^2/s -> come from tracer experiments (method of moments)
v=7.1e-6;    % average transport velocity m/s -> come from tracer experiments (method of moments)
Z_fix=1;   % select depth for plotting C(Z_fix,time)
dt= 3600;% timestep with in s
max_time= 10*86400; % maximum transport time s
dz=0.05; %grid  size m
